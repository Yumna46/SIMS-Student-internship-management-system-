...
public class AdminLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sims/user.png"))); // NOI18N

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sims/lock2.png"))); // NOI18N
    ...
    public void login(){
        try{
            ...
            String sql= "SELECT * FROM FACULTY_LOGIN WHERE FacultyName ='"+username.getText().toString()+"'";
            ResultSet resultSet = statement.executeQuery(sql);
            System.out.println(resultSet);
            if(resultSet.next()){
                if(password.getText().toString().equals(resultSet.getString("FacultyPassword"))){
